...
public class ComputerPatternEulerAttribute extends AttributeComputedIncrementally {
	...
	private class GrayScalePattern {
		...
		public GrayScalePattern(){
			quads = new ArrayList<ComputerPatternEulerAttribute.GrayScaleQuadBit>();
		}
	...
	private class GrayScalePatternGroup
	{
		...
		public GrayScalePatternGroup() {
			patterns = new ArrayList<ComputerPatternEulerAttribute.GrayScalePattern>();
		}
	...
	public void addAttributeInNodes(NodeLevelSets node){
		node.addAttribute(Attribute.NUM_HOLES, new Attribute(Attribute.NUM_HOLES, attr[ node.getId() ].getNumberHoles(adj)));
	...
	private void computerLocalPattern(NodeLevelSets node, int p) {
	 ...
	 public class PatternEulerAttribute {
		...
		public int getNumberHoles(AdjacencyRelation adj) {
