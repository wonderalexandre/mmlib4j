...
public class ColorSpace {
    ...
    public static RealImage[] getColorSpaceXYZ(RGBImage img){
        ...
        RealImage c1 = ImageFactory.instance.createRealImage(img.getWidth(), img.getHeight());
        RealImage c2 = ImageFactory.instance.createRealImage(img.getWidth(), img.getHeight());
        RealImage c3 = ImageFactory.instance.createRealImage(img.getWidth(), img.getHeight());
    ...
    */
    ...
    public static RealImage[] getColorSpaceCMYK(RGBImage img){
        ...
        RealImage c2 = ImageFactory.instance.createRealImage(img.getWidth(), img.getHeight());
        RealImage c3 = ImageFactory.instance.createRealImage(img.getWidth(), img.getHeight());
        RealImage c4 = ImageFactory.instance.createRealImage(img.getWidth(), img.getHeight());
