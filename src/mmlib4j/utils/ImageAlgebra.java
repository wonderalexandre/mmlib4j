...
public class ImageAlgebra {
    ...
    public static GrayScaleImage minimum(GrayScaleImage imgA, GrayScaleImage imgB){
        GrayScaleImage imgM = ImageFactory.instance.createGrayScaleImage(imgA.getDepth(), imgA.getWidth(), imgA.getHeight());
    ...
    public static GrayScaleImage subtraction(GrayScaleImage imgA, GrayScaleImage imgB){
        GrayScaleImage imgOut = ImageFactory.instance.createGrayScaleImage(imgA.getDepth(), imgA.getWidth(), imgA.getHeight());
