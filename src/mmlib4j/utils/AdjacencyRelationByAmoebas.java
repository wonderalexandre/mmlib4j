...
public class AdjacencyRelationByAmoebas {
	...
	public static void main(String args[]){
		...
		GrayScaleImage imgMedia = ImageFactory.instance.createGrayScaleImage(img.getDepth(), img.getWidth(), img.getHeight());
		GrayScaleImage imgMediaAboema = ImageFactory.instance.createGrayScaleImage(img.getDepth(), img.getWidth(), img.getHeight());
